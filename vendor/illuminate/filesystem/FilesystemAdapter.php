...
use Illuminate\Http\ResourceFile;
...
class FilesystemAdapter implements CloudFilesystemContract
{
        ...
        foreach ($paths as $path) {
            ...
            if (! is_null($content)) {
                ...
                PHPUnit::assertSame(
                    $content,
                    $actual,
                    "ResourceFile or directory [{$path}] was found, but content [{$actual}] does not match [{$content}]."
                );
            }
        }
     ...
     *
     * @param  string  $path
     * @param  \Psr\Http\Message\StreamInterface|\Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string|resource  $contents
     * @param  mixed  $options
     * @return string|bool
     */
    public function put($path, $contents, $options = [])
    {
        ...
        if ($contents instanceof ResourceFile ||
     ...
     *
     * @param  \Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string  $path
     * @param  \Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string|array|null  $file
     * @param  mixed  $options
     * @return string|false
     */
    public function putFile($path, $file = null, $options = [])
    {
        ...
        $file = is_string($file) ? new ResourceFile($file) : $file;
