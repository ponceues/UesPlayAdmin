 ...
 * @method static bool put(string $path, \Psr\Http\Message\StreamInterface|\Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string|resource $contents, mixed $options = [])
 * @method static string|false putFile(\Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string $path, \Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string|array|null $file = null, mixed $options = [])
 * @method static string|false putFileAs(\Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string $path, \Illuminate\Http\ResourceFile|\Illuminate\Http\UploadedFile|string|array|null $file, string|array|null $name = null, mixed $options = [])
